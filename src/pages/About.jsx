  ...
  return (
    <div className='mt-24'>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        <img className='w-full rounded-xl md:max-w-[450px]' src={assets.about_img} alt='' />
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
        ...
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Convenience:</b>
          <p className='text-gray-600'>With our user-friendly interface and hassle-free process, shopping is a breeze.</p>
        </div>
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
